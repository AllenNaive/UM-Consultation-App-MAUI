...
namespace UM_Consultation_App_MAUI
{
    public partial class App : Application
    {
        public App()
        {
            ...
            MainPage = new NavigationPage(new LoginPage()); //startup in order for the create account button to work (change the structure if needed)
            ...
            //Shell.Current.GoToAsync("//Faculty"); // Set the initial page to FacultyView, change this to StudentView if needed (debug purposes para sa navigation bar)
        }
    }
}
